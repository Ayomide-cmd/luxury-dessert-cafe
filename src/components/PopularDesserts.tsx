...
import { useSectionTransition, useStaggerAnimation } from '@/hooks/useScrollAnimation';
import Image from 'next/image';
import type { Dessert } from '@/types';

const desserts: Dessert[] = [
  { id: 1, name: 'Chocolat au glace ', origin: 'FR', size: '2.5 in', price: 12100 },
  { id: 2, name: 'Double Filled Macaron', origin: 'FR', size: 'Box of 6', price: 4050 },
  { id: 3, name: 'Yuzu Creme pie ', origin: 'JP', size: '6 in', price: 28000 },
  { id: 4, name: 'Hoji Cafe Éclair', origin: 'FR-JP', size: '120ml', price: 15000 },
];
          ...
          {desserts.map((dessert, index) => (
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                <Image
                  src={`/images/dessert-${index + 1}.png`}
                  alt={dessert.name}
                  fill
