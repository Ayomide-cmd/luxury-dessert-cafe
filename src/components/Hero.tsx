    ...
    >
      ...
      >
        <div className="md:hidden">
          <div className="decor-item absolute top-12 -left-8 w-28 h-28 opacity-40">
            <div className="absolute inset-0 bg-pink-500/15 blur-2xl rounded-full animate-pulse-slow"></div>
            <Image src="/images/coffee-bean-left.png" alt="" fill className="object-contain filter drop-shadow-[0_0_20px_rgba(236,72,153,0.3)]" sizes="112px" loading="eager" />
          </div>

          <div className="decor-item absolute top-16 -right-8 w-32 h-32 opacity-40">
            <div className="absolute inset-0 bg-pink-400/15 blur-2xl rounded-full animate-pulse-slow animation-delay-2000"></div>
            <Image src="/images/hero-left-leaf.png" alt="" fill className="object-contain filter drop-shadow-[0_0_20px_rgba(236,72,153,0.3)]" sizes="128px" loading="eager" />
          </div>
        </div>

        <div className="hidden md:block">
          <div className="decor-item absolute top-8 left-4 md:top-14 md:left-4 lg:top-16 lg:left-16 xl:left-24 w-40 h-40 md:w-56 md:h-56 lg:w-80 lg:h-80 xl:w-96 xl:h-96 opacity-45 md:opacity-50 lg:opacity-55 hover:opacity-70 transition-opacity duration-500">
            <div className="absolute inset-0 bg-pink-500/20 blur-3xl rounded-full animate-pulse-slow"></div>
            <Image src="/images/coffee-bean-left.png" alt="" fill className="object-contain filter drop-shadow-[0_0_40px_rgba(236,72,153,0.4)]" sizes="(min-width: 1280px) 384px, (min-width: 1024px) 320px, (min-width: 768px) 224px, 160px" priority />
          </div>

          <div className="decor-item absolute top-14 right-2 md:top-20 md:right-2 lg:top-20 lg:right-12 xl:right-24 w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 xl:w-72 xl:h-72 opacity-45 md:opacity-50 lg:opacity-55 hover:opacity-70 transition-opacity duration-500">
            <div className="absolute inset-0 bg-pink-400/20 blur-3xl rounded-full animate-pulse-slow animation-delay-2000"></div>
            <Image src="/images/hero-left-leaf.png" alt="" fill className="object-contain filter drop-shadow-[0_0_40px_rgba(236,72,153,0.4)]" sizes="(min-width: 1280px) 288px, (min-width: 1024px) 256px, (min-width: 768px) 224px, 192px" priority />
          </div>

          <div className="decor-item absolute bottom-20 left-0 md:bottom-28 md:left-0 lg:bottom-32 lg:left-12 xl:left-48 w-56 h-56 md:w-64 md:h-64 lg:w-72 lg:h-72 xl:w-80 xl:h-60 opacity-35 md:opacity-40 lg:opacity-35 hover:opacity-55 transition-opacity duration-500">
            <div className="absolute inset-0 bg-pink-300/15 blur-3xl rounded-full animate-pulse-slow animation-delay-1000"></div>
            <Image src="/images/swirl-decoration-v2.png" alt="" fill className="object-contain filter drop-shadow-[0_0_50px_rgba(236,72,153,0.3)]" sizes="(min-width: 1280px) 320px, (min-width: 1024px) 288px, (min-width: 768px) 256px, 224px" priority />
          </div>

          <div className="decor-item absolute bottom-16 right-0 md:bottom-24 md:right-0 lg:bottom-26 lg:right-8 xl:right-20 w-52 h-52 md:w-60 md:h-60 lg:w-72 lg:h-72 xl:w-80 xl:h-80 opacity-40 md:opacity-40 lg:opacity-45 hover:opacity-65 transition-opacity duration-500">
            <div className="absolute inset-0 bg-pink-400/15 blur-3xl rounded-full animate-pulse-slow animation-delay-3000"></div>
            <Image src="/images/coffee-bean-right.png" alt="" fill className="object-contain filter drop-shadow-[0_0_50px_rgba(236,72,153,0.3)]" sizes="(min-width: 1280px) 320px, (min-width: 1024px) 288px, (min-width: 768px) 240px, 208px" priority />
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-12 sm:bottom-16 md:bottom-20 left-1/2 -translate-x-1/2 z-30 flex flex-col items-center gap-4 sm:gap-5 md:gap-6"> 
        ...
        <div className="hero-animate cursor-pointer hover:text-pink-100 transition-colors">
          <div className="inline-flex flex-col items-center gap-2 text-pink-200/60">
            <span className="text-xs font-medium tracking-widest uppercase mb-2"></span>
            <div className="relative w-8 h-8 flex items-center justify-center">
              <div className="absolute inset-0 rounded-full bg-pink-400/30 animate-ping-slow"></div>
              <div className="absolute inset-1 rounded-full bg-pink-400/40 blur-sm animate-pulse-slow"></div>
              <div className="relative w-4 h-4 rounded-full bg-gradient-to-br from-pink-400 to-pink-600 shadow-lg shadow-pink-500/50 animate-nudge-down"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .animate-nudge-down { animation: nudge-down 2s ease-in-out infinite; }
