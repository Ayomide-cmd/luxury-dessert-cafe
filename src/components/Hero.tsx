  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="decor-item absolute bottom-32 left-16 lg:left-32 w-80 h-80 lg:w-80 lg:h-80 opacity-35 hover:opacity-50 transition-opacity duration-500">
          <div className="absolute inset-0 bg-pink-300/12 blur-3xl rounded-full animate-pulse-slow animation-delay-2000"></div>
          <Image
            src="/images/swirl-decoration.png"
            alt=""
            fill
  ...
  />
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <div className="hero-animate cursor-pointer hover:text-pink-100 transition-colors">
          <div className="inline-flex flex-col items-center gap-2 text-pink-200/60 animate-bounce-slow">
            <span className="text-xs font-medium tracking-widest uppercase">Scroll</span>
            <svg className="w-5 h-5 hover:translate-y-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
